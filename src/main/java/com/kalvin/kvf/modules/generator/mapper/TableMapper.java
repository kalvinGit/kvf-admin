...
public interface TableMapper {
    ...
    @Select("select table_name,table_comment from information_schema.TABLES where TABLE_SCHEMA=(select database()) and table_name not like 'qrtz_%' and table_name not like 'QRTZ_%' and table_name not like 'act_%' and table_name NOT LIKE 'ACT_%'")
